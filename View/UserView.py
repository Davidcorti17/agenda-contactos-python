...
class UserView:
    ...
    def delete_user_menu(self):
        ...
        print("-" * 50)
        user_controller = UserController()
        user_for_deletion = UserForCreation(username, "", "", "", "")
        validation = user_controller.delete_user(user_for_deletion)
        if validation:
            print(" Usuario eliminado correctamente ".center(50, "!"))
        else:
            print(" Error al eliminar el usuario ".center(50, "!"))
        input(" Presione enter para continuar ".center(50, "!"))
